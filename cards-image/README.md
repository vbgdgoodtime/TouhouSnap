...
> ⚠️ **版本更新（人物更名）**：露米娅 / 博丽灵梦 / 蕾米莉亚 / 东风谷早苗 / 贤者（原伊吹萃香更名，现无图、emoji 兜底）已实装为白板换皮卡——对应旧文件（rumia/reimu/remilia/sanae.png）当前**未被引用**，保留备用。
> ✅ 红美铃已作为新卡重新实装（2费/3力/mv，红魔馆成员），`meiling.png` 恢复引用。
> ✅ v70 伊吹萃香已作为**新卡重新实装**（5费/12力，大体积占 4 格），`suika.png` 恢复引用。

## 当前素材状态（2026-09-08 第三次同步 · 已补齐）

已从 `/图片素材` 复制并改名就位 **25 张 = 全部卡牌**（原图为 100px Q 版立绘缩略图，放大视图会偏糊，建议日后用更大尺寸替换）：
...
| mokou.png | 藤原妹红 | |
| suwako.png | 洩矢诹访子 | |
| hina.png | 键山雏 | 🔧 v57 新增：素材自 /图片素材（100px Q 版立绘） |
| okuu.png | 灵乌路空 | 🔧 v60 新增：素材自 /图片素材（100px Q 版立绘） |
| hecatia.png | 赫卡提亚 | 🔧 v61 新增：素材自 /图片素材（100px Q 版立绘）；「赫卡提亚的分身」共用此图 |
| shion.png | 依神紫苑 | 🔧 v63 新增：素材自 /图片素材（100px Q 版立绘） |
| mamizou.png | 二岩猯藏 | 🔧 v64 新增：素材自 /图片素材（100px Q 版立绘） |
| tewi.png | 因幡帝 | 🔧 v66 新增：素材自 /图片素材的 `100px-因幡天为（Q版立绘）.png`（素材名“因幡天为”，卡牌名为“因幡帝”） |
| akyuu.png | 稗田阿求 | 🔧 v69 新增：素材自 /图片素材（100px Q 版立绘）；0 费卡暂不入牌库 |
| letty.png | 蕾蒂 | 🔧 v77 新增：素材自 /图片素材（100px Q 版立绘） |

✅ **25 张卡全部有图**，游戏里将不再显示 emoji 兜底。

> 素材目录中另有 上白泽慧音2 / 八云蓝 / 因幡天为 / 小恶魔 / 橙 / 爱丽丝 / 莉莉霍瓦特 / 蓬莱山辉夜 / 铃仙 / 露娜萨 等图片，对应角色目前不在本游戏卡池中，未复制。
